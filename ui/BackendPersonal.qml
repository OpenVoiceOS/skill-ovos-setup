...
Item {
    ...
    ListModel {
        ...
        ListElement {
            text: QT_TR_NOOP("Needs to be hosted in a private network before hand")
        }
        ListElement {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Kirigami.Icon {
                id: topAreaIcon
                source: Qt.resolvedUrl("icons/personal.svg")
        ...
        ColumnLayout {
            ...
            Label {
                ...
                text: qsTr("Manage all your devices using a personal backend")
            }
